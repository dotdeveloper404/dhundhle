        ...
        <div class="d-flex items-center">
          <h3>
            <a href="index.html" class="header-logo mr-20" data-x="header-logo" data-x-toggle="is-logo-dark">
              <!-- <img src="frontend/img/general/logo-light.svg" alt="logo icon">
                <img src="frontend/img/general/logo-dark.svg" alt="logo icon"> -->
              iLinkTurkey
            </a>
          </h3>
                        ...
                        <div class="tabs__content js-tabs-content">
                          <div class="tabs__pane -tab-item-1 is-tab-el-active">
                            <div class="mega__content">
                              ...
                              <div class="mega__image d-flex relative">
                                <img src="#" data-src="frontend/img/backgrounds/7.png" alt="image" class="rounded-4 js-lazy">
                          ...
                          <div class="tabs__pane -tab-item-2">
                            <div class="mega__content">
                              ...
                              <div class="mega__image d-flex relative">
                                <img src="frontend/img/backgrounds/7.png" alt="image" class="rounded-4">
