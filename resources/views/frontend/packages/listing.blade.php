...
<div class="border-top-light pt-30">
  <div class="row x-gap-20 y-gap-20">
    ...
    <div class="col-md-auto text-right md:text-left">
      ...
      <a href="{{ route('packages.show',$package->id) }}" class="button -md -dark-1 bg-blue-1 text-white mt-24">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/1.png')}}" alt="image">
                        ...
                        <div class="cardImage__content">
                          ...
                          <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                            <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/2.png')}}" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/3.png')}}" alt="image">
                              </div>

                              <div class="swiper-slide">
                                <img class="col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/4.png')}}" alt="image">
                              </div>
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/3.png')}}" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/4.png')}}" alt="image">
                    ...
                    <div class="col-md-auto">
                      ...
                      <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12 js-lazy" src="#" data-src="{{ asset('frontend/img/lists/tour/1/5.png')}}" alt="image">
