...
<section class="pt-40">
      <div class="container">
        <div class="row y-gap-15 justify-between items-end">
          <div class="col-auto">
            <h1 class="text-30 fw-600">{{ $package->package_name}}</h1>
                ...
                <div class="row x-gap-10 items-center">
                  <div class="col-auto">
                    <div class="d-flex x-gap-5 items-center">
                      ...
                      <div class="text-15 text-light-1">{{ $package->city}}</div>
                    </div>
                  </div>
            ...
            <div class="relative d-flex justify-center overflow-hidden js-section-slider" data-slider-cols="base-1" data-nav-prev="js-img-prev" data-nav-next="js-img-next">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="{{asset('frontend/img/lists/tour/single/1.png')}}" alt="image" class="rounded-4 col-12 h-full object-cover">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('frontend/img/gallery/1/2.png')}}" alt="image" class="rounded-4 col-12 h-full object-cover">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('frontend/img/gallery/1/3.png')}}" alt="image" class="rounded-4 col-12 h-full object-cover">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('frontend/img/gallery/1/4.png')}}" alt="image" class="rounded-4 col-12 h-full object-cover">
                </div>
              ...
              <div class="absolute h-full col-12 z-2 px-20 py-20 d-flex justify-end items-end">
                <a href="{{asset('frontend/img/lists/tour/single/1.png')}}" class="button -blue-1 px-24 py-15 bg-white text-dark-1 js-gallery" data-gallery="gallery2">
                  See All 90 Photos
                </a>
                <a href="{{asset('frontend/img/gallery/1/2.png')}}" class="js-gallery" data-gallery="gallery2"></a>
                <a href="{{asset('frontend/img/gallery/1/3.png')}}" class="js-gallery" data-gallery="gallery2"></a>
                <a href="{{asset('frontend/img/gallery/1/4.png')}}" class="js-gallery" data-gallery="gallery2"></a>
                <a href="{{asset('frontend/img/gallery/1/5.png')}}" class="js-gallery" data-gallery="gallery2"></a>
              </div>
            </div>
