<template>
    <div>
        <div class="">
            <div class="gallery width-100" :class="error?'red-border':''">
                ...
                <div class="elements-wraper">
                    ...
                    <div v-for="(image, index) in savedMedia" :key="index" class="image-container image-margin">
                        <img :src="mediaFilePath +'/'+ image.name" alt=""  class="images-preview">
                    ...
                    <div v-for="(image, index) in addedMedia" :key="index" class="image-container image-margin">
        ...
        <div v-for="(image, index) in addedMedia" :key="index" class="m-top">
            <input type="text" name="added_media[]" :value="image.name" hidden>
        </div>
        <div v-for="(image, index) in deletedMedia" :key="index" class="m-top">
            <input type="text" name="deleted_media[]" :value="image.name" hidden>
        </div>
        <div v-if="addedMedia.length||savedMedia.length" class="m-top">
